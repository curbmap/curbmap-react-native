...
import { StyleSheet, View, Image, TextInput, Text, Button, Dimensions } from 'react-native'
          ...
          .then((responseJSON) => {
            ...
            switch (responseJSON.success) {
              ...
              case -3:
                this.setState({
                  signuperror:
                    'Password needs one capital, lowercase, special, number, and be between 9 and 64 chars',
                })
                break
              case -4:
